  ...
  return (
    <motion.main
      ...
      className={`flex justify-center items-center 
        mx-0 md:mx-20 `}
    >
      <div className="bg-cyan-50 w-[70vw] md:min-h-[80vh] md:mt-[3vh]" id="CartDetails">
      <section id="listos" className="bg-stone-700">
            <div className="px-6 pt-20 top-30 pb-2">
            <h1 className="font-bold text-4xl top-30 text-white justify-center 
              text-center z-20" id="todoListo">Listos Para el Combate</h1>
             </div>
           </section>
        <BackgroundCol typeName={pokeData?.types[0].type.name}>
          ...
          >
            ...
            <p className="text-white font-bold text-xl mt-2">
              Experiencia en Combate °{pokeData?.base_experience}
            </p>
            <button className="text-white font-bold text-xl mt-2 bg-zinc-900 hover:bg-sky-600 px-1.5 py-1 rounded-lg duration-200 ease-in">Añadir a Lista</button>
